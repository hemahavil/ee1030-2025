...
\begin{align}
         ...
         \begin{align}
             |\vec{X}|=\sqrt{\brak{x_2-x_1}^2+\brak{y_2-y_1}^2+\brak{z_2-z_1}^2}
         \end{align}
	\end{frame}
    \begin{frame}{Theoretical Solution}
        \begin{align}
             |\vec{X}|=\sqrt{\brak{4-1}^2+\brak{5-2}^2+\brak{6-3}^2}
         \end{align}
         \begin{align}
             |\vec{X}|=\sqrt{\brak{3}^2+\brak{3}^2+\brak{3}^2}
         \end{align}
         \begin{align}
             |\vec{X}|=\sqrt{3\brak{3}^2}
         \end{align}
         \begin{align}
             |\vec{X}|=3\sqrt{3}
         \end{align}
